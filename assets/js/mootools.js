! function() {
    ...
    function() {
        ...
        if ("ie" == r.name && t.documentMode && (r.version = t.documentMode), r.extend({
                ...
                return !0 === t ? r.exec(e) : "function" == typeOf(t) && t(e, n), n
            }), r.extend({
        ...
        if (this.attachEvent && !this.addEventListener) {
            var i = function() {
                this.detachEvent("onunload", i), t.head = t.html = t.window = null, e = this.Window = t = null
            };
        ...
        try {
            ...
            ["pop", "push", "reverse", "shift", "sort", "splice", "unshift", "concat", "join", "slice"].each(function(t) {
                var e = o[t];
                Array[t] = function(t) {
                    return e.apply(Array.convert(t), a.call(arguments, 1))
                }
            })
        }
    }(),
    ...
    function() {
        ...
        t.isNativeCode = function(t) {
            ...
            if (this.document !== t) {
                ...
                if (o)
                    ...
                    (o = e[s] = {}).root = i, o.isXMLDocument = this.isXML(t), o.brokenStarGEBTN = o.starSelectsClosedQSA = o.idGetsName = o.brokenMixedCaseQSA = o.brokenGEBCN = o.brokenCheckedQSA = o.brokenEmptyAttributeQSA = o.isHTMLDocument = o.nativeMatchesSelector = !1;
                    ...
                    var v = i && this.isNativeCode(i.contains),
                        g = t && this.isNativeCode(t.contains);
                    o.contains = v && g ? function(t, e) {
                        return t.contains(e)
                    } : v && !g ? function(e, n) {
        ...
        t.search = function(t, e, n, o) {
                ...
                t: if (v) {
                    ...
                    if (g) {
                        if ("#" == g) {
                            ...
                            if (!(l = t.getElementById(y))) return a;
            ...
            var w, k, T, C, N, O, A, L, M, $, j, D, P, H, F = u.expressions;
            t: for (c = 0; D = F[c]; c++)
                for (w = 0; P = D[w]; w++) {
                    if (C = "combinator:" + P.combinator, !this[C]) continue t;
                    if (N = this.isXMLDocument ? P.tag : P.tag.toUpperCase(), O = P.id, A = P.classList, L = P.classes, M = P.attributes, $ = P.pseudos, H = w === D.length - 1, this.bitUniques = {}, H ? (this.uniques = p, this.found = a) : (this.uniques = {}, this.found = []), 0 === w) {
                        if (this[C](t, N, O, L, M, $, A), o && H && a.length) break t
                    } else if (o && H) {
                        for (k = 0, T = j.length; T > k; k++)
                            if (this[C](j[k], N, O, L, M, $, A), a.length) break t
                    } else
                        for (k = 0, T = j.length; T > k; k++) this[C](j[k], N, O, L, M, $, A);
                    j = this.found
                }
            ...
            if (r)
                for (a = r.length; a--;)
                    if (!(c = this.getAttribute(t, "class")) || !r[a].regexp.test(c)) return !1;
            if (i)
                for (a = i.length; a--;)
                    if ((u = i[a]).operator ? !u.test(this.getAttribute(t, u.key)) : !this.hasAttribute(t, u.key)) return !1;
            if (s)
                for (a = s.length; a--;)
        ...
        var o = {
            ...
            ">": function(t, e, n, r, i, s) {
                if (t = t.firstChild)
                    do {
                        1 == t.nodeType && this.push(t, e, n, r, i, s)
            ...
            "^": function(t, e, n, r, i, s) {
                (t = t.firstChild) && (1 == t.nodeType ? this.push(t, e, n, r, i, s) : this["combinator:+"](t, e, n, r, i, s))
            },
            "~": function(t, e, n, r, i, s) {
                for (; t = t.nextSibling;)
                    if (1 == t.nodeType) {
            ...
            "!>": function(t, e, n, r, i, s) {
                (t = t.parentNode) !== this.document && this.push(t, e, n, r, i, s)
            },
            "!+": function(t, e, n, r, i, s) {
            ...
            "!^": function(t, e, n, r, i, s) {
                (t = t.lastChild) && (1 == t.nodeType ? this.push(t, e, n, r, i, s) : this["combinator:!+"](t, e, n, r, i, s))
            },
            "!~": function(t, e, n, r, i, s) {
                for (; t = t.previousSibling;)
                    if (1 == t.nodeType) {
...
Elements.prototype = {
    ...
    function() {
        ...
        Document.implement({
            newElement: function(t, e) {
                if (e) {
                    if (null != e.checked && (e.defaultChecked = e.checked), "checkbox" != e.type && "radio" != e.type || null != e.value || (e.value = "on"), !i && "style" == t) {
                        var s = document.createElement("style");
                        return s.setAttribute("type", "text/css"), e.type && delete e.type, this.id(s).set(e)
                    }
                    n && (t = "<" + t, e.name && (t += ' name="' + r(e.name) + '"'), e.type && (t += ' type="' + r(e.type) + '"'), t += ">", delete e.name, delete e.type)
                }
    ...
    function() {
            ...
            id: function() {
                var t = {
                    string: function(e, n, r) {
                        return (e = Slick.find(r, "#" + e.replace(/(\W)/g, "\\$1"))) ? t.element(e, n) : null
                    },
        ...
        var e = function(t, e) {
            if (!t) return e;
            for (var n = (t = Object.clone(Slick.parse(t))).expressions, r = n.length; r--;) n[r][0].combinator = e;
            return t
        };
        Object.forEach({
            getNext: "~",
        ...
        p.value = "t", p.type = "submit", c = "t" != p.value;
        try {
            p.value = "", p.type = "email", h = "email" == p.type
        } catch (t) {}
        p = null, (c || !h) && (i.type = function(t, e) {
            try {
                var n = t.value;
                t.type = e, t.value = n
            } catch (t) {}
        ...
        Element.implement("appendHTML", "insertAdjacentHTML" in document.createElement("div") ? function(t, e) {
            return this.insertAdjacentHTML(x[e || "bottom"], t), this
        } : function(t, e) {
        ...
        var E = {},
            ...
            k = function(t) {
                ...
                return t.removeEvents && t.removeEvents(), t.clearAttributes && t.clearAttributes(), null != e && (delete E[e], delete S[e]), t
            },
            T = {
                input: "checked",
                option: "selected",
        ...
        if (Element.implement({
                ...
                addListener: function(t, e) {
                    return window.attachEvent && !window.addEventListener && (E[Slick.uidOf(this)] = this), this.addEventListener ? this.addEventListener(t, e, !!arguments[2]) : this.attachEvent("on" + t, e), this
                },
                ...
                store: function(t, e) {
                    return w(Slick.uidOf(this))[t] = e, this
                },
                eliminate: function(t) {
                    return delete w(Slick.uidOf(this))[t], this
                }
            }), window.attachEvent && !window.addEventListener) {
            var C = function() {
                Object.each(E, k), window.CollectGarbage && CollectGarbage(), window.removeListener("unload", C)
            };
        ...
        if (M.innerHTML = "<nav></nav>", !(O = 1 == M.childNodes.length)) {
            var $ = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" ");
            for (N = document.createDocumentFragment(), l = $.length; l--;) N.createElement($[l])
        }
        M = null, A = Function.attempt(function() {
            return document.createElement("table").innerHTML = "<tr><td></td></tr>", !0
        });
        var j = document.createElement("tr"),
            D = "<td></td>";
        j.innerHTML = D, L = j.innerHTML == D, j = null, A && L && O || (Element.Properties.html.set = function(t) {
            var e = {
                table: [1, "<table>", "</table>"],
            ...
            return e.thead = e.tfoot = e.tbody,
                function(n) {
                    ...
                    if (r || O || (r = [0, "", ""]), !r) return t.call(this, n);
                    var i = r[0],
                        s = document.createElement("div"),
                        o = s;
                    for (O || N.appendChild(s), s.innerHTML = [r[1], n, r[2]].flatten().join(""); i--;) o = o.firstChild;
                    this.empty().adopt(o.childNodes), O || N.removeChild(s), s = null
                }
        }(Element.Properties.html.set));
        var P = document.createElement("form");
        P.innerHTML = "<select><option>s</option></select>", "s" != P.firstChild.value && (Element.Properties.value = {
            set: function(t) {
                ...
                for (var n = 0; n < e.length; n++) {
                    var r = e[n],
                        i = r.getAttributeNode("value");
                    if ((i && i.specified ? r.value : r.get("text")) === t) return r.selected = !0
                }
            },
            get: function() {
                var t = this,
        ...
        }), P = null, document.createElement("div").getAttributeNode("id") && (Element.Properties.id = {
            set: function(t) {
    ...
    function() {
        var t = {},
            ...
            n = this.DOMEvent = new Type("DOMEvent", function(n, r) {
                if (r || (r = window), (n = n || r.event).$extended) return n;
        ...
        Element.Properties.events = {
            ...
            addEvent: function(t, e) {
                ...
                i && (i.onAdd && i.onAdd.call(this, e, t), i.condition && (s = function(n) {
                    return !i.condition.call(this, n, t) || e.call(this, n)
        ...
        var o = Element.prototype,
            ...
            l = {
                ...
                removeEvent: function(t, e, r, i) {
                    ...
                    if (r) {
                        for (f in o)
                            if ((p = o[f]).match == e && p.fn == r) return l.removeEvent.call(this, t, e, r, f)
                    } else
                        for (f in o)(p = o[f]).match == e && l.removeEvent.call(this, t, e, p.fn, f);
                    return this
                }
            };
        [Element, Window, Document].invoke("implement", {
    ...
    function() {
        ...
        (t = document.createElement("div")).style.color = "red", t.style.color = null;
        ...
        var a = null != e.style.opacity,
            ...
            h = a ? function(t, e) {
                ...
                t.currentStyle && t.currentStyle.hasLayout || (t.style.zoom = 1), null == e || 1 == e ? (l(t, c, ""), 1 == e && 1 != f(t) && l(t, c, "alpha(opacity=100)")) : l(t, c, "alpha(opacity=" + (100 * e).limit(0, 100).round() + ")")
            } : function(t, e) {
            ...
            p = null == e.style.cssFloat ? "styleFloat" : "cssFloat",
            d = {
                left: "0%",
                top: "0%",
                center: "50%",
            ...
            m = null != e.style.backgroundPositionX,
            v = /^-(ms)-/,
            g = function(t) {
                return t.replace(v, "$1-").camelCase()
            },
            y = function(t, e) {
        ...
        Element.implement({
            getComputedStyle: function(t) {
                if (!s && this.currentStyle) return this.currentStyle[g(t)];
                var e = Element.getDocument(this).defaultView,
                    n = e ? e.getComputedStyle(this, null) : null;
                return n ? n.getPropertyValue(t == p ? "float" : t.hyphenate()) : ""
            },
            setStyle: function(t, e) {
                if ("opacity" == t) return null != e && (e = parseFloat(e)), h(this, e), this;
                if (t = g("float" == t ? p : t), "string" != typeOf(e)) {
                ...
                return this.style[t] = e, ("" == e || null == e) && n && this.style.removeAttribute && y(this.style, t), this
            },
            getStyle: function(t) {
                if ("opacity" == t) return f(this);
                if (t = g("float" == t ? p : t), o && -1 != t.indexOf("borderRadius")) return ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"].map(function(t) {
                ...
                if (m && /^backgroundPosition[XY]?$/.test(t)) return e.replace(/(top|right|bottom|left)/g, function(t) {
                    return d[t]
                }) || "0px";
                if (!e && "backgroundPosition" == t) return "0px 0px";
                if (e) {
                    var r = (e = String(e)).match(/rgba?\([\d\s,]+\)/);
        ...
        }), m && (Element.ShortStyles.backgroundPosition = {
            backgroundPositionX: "@",
            backgroundPositionY: "@"
        })
    }(),
            ...
            getOffsets: function() {
                if (this.getBoundingClientRect) {
                    var t = this.getBoundingClientRect(),
                        ...
                        n = e.getScroll(),
                        i = this.getScrolls(),
                        s = "fixed" == p(this, "position");
                    return {
                        x: t.left.toFloat() + i.x + (s ? 0 : n.x) - e.clientLeft,
                        y: t.top.toFloat() + i.y + (s ? 0 : n.y) - e.clientTop
                    }
                }
                var o = this,
                    a = {
                ...
                if (r(this)) return a;
                for (; o && !r(o);) a.x += o.offsetLeft, a.y += o.offsetTop, o = o.offsetParent;
                return a
            },
    ...
    function() {
        ...
        parse: function(t) {
            return t = Function.convert(t)(), (t = "string" == typeof t ? t.split(" ") : Array.convert(t)).map(function(t) {
                t = String(t);
                var e = !1;
            ...
            var e = {},
                ...
                r = function(t) {
                    Array.each(t, function(t) {
                        if (t.media) r(t.rules || t.cssRules);
                        else if (t.style) {
